...
<template>
  ...
  <div class="relative flex min-h-screen flex-col">
    <Header :extra-top-padding="isHome" />
...
<style lang="postcss">
  ...
  .custom-scrollbar::-webkit-scrollbar {
    @apply w-1.5 rounded bg-gray-100;
  }
  ...
  input[type='checkbox'],
  input[type='radio'] {
    @apply w-full cursor-pointer appearance-none rounded-lg border border-gray-300 bg-white p-3 font-sans outline-none transition-all duration-150 hover:border-primary;
