    ...
    <div class="my-10">
      <div class="mb-6 flex justify-between">
        <div class="flex flex-col gap-1">
          ...
          <span class="text-xl font-normal text-[#3E3E3E]">{{
            props?.orderData?.orderNumber
          }}</span>
        </div>
        <div
          class="flex h-max items-center rounded-full border border-[#FBE0E0] bg-[#ECC0C0] px-3 py-2 text-xs normal-case text-[#CD0909]"
        >
          {{ props.paymentData?.status }}
        </div>
      </div>
      <div>
        <span class="mb-1 text-xl font-normal text-[#757575]">Payment Information</span>
        <p class="mb-5 text-[#3E3E3E]">
          Upon completing your purchase, please proceed with a bank transfer to make the payment.
          Below you will find the necessary bank information and the total amount to be paid.
        </p>
