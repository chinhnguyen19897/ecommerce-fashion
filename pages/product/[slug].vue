  ...
  <div class="mb-11">
    <div class="flex flex-col gap-12 md:flex-row">
      <ProductImageGallery
        ...
        class="w-full xl:max-w-[656px]"
      />
      <div class="w-full md:py-2 lg:max-w-md xl:max-w-[670px]">
        ...
        <div class="mt-3">
          <h1 class="mb-4 py-4 font-playfair text-7xl font-medium uppercase text-[#3E3E3E]">
        ...
        <div class="my-8">
          <p class="mb-4 text-xl text-[#B4B4B4]">Quantity</p>
